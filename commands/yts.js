...
async function buscar(query) {
  ...
  return data.data.filter((v) => v?.type === 'video' && v?.url).slice(0, 5).map((v) => ({
    ...
    channel: v.author?.name || v.author || 'YouTube',
